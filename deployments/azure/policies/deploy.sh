...
echo -e "${BLUE}=== Azure Policy Deployment for Region Control ===${NC}"
...
# Deploy the policies
echo -e "${BLUE}Deploying Azure policies for region control...${NC}"
...
if [ "$DEPLOYMENT_RESULT" = "Succeeded" ]; then
    ...
    echo -e "${GREEN}Region control policies have been successfully deployed!${NC}"
